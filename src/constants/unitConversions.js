export default {
    ...
    ip: {
        ...
        specific_heat: {conversion: {multiply: 0.238845897}, label: 'Btu/lb-F', decimals: 2},
        density: {conversion: {multiply: 0.062428}, label: 'lb/ft3', decimals: 2},
        percent: {conversion: null, label: '%', decimals: 1},
        outdoor_air_percentage: {conversion: null, label: '%', decimals: 2},
        heat_transfer_rate_per_area: {conversion: {multiply: 0.316998305}, label: 'Btu/hr-ft2', decimals: 2},
        area_per_heat_transfer_rate: {conversion: {multiply: 3.154591}, label: 'ft2-hr/Btu', decimals: 4},
        flow_rate_per_area: {conversion: {multiply: 196.8504938}, label: 'ft3/min-ft2', decimals: 4},
        flow_rate_per_heat_transfer_rate: {conversion: {multiply: 620.9830765}, label: 'ft3-hr/min-Btu', decimals: 4},
        people: {conversion: null, label: null, decimals: 1},

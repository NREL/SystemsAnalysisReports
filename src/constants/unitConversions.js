...
let conversions = {
    ...
    'F_diff': {'convert':(value) => {return value * 1.8 + 32}, label: '°F'},
    ...
    'm2/kW': {'convert':(value) => {return value }, label: 'm2/kW'},
    'ft2/ton_r': {'convert':(value) => {return value * 10.76391041671 * 3516.8528421}, label: 'ft2/ton'},
    'ft2/kbtu/hr': {'convert':(value) => {return value * 10.76391041671 * 3516.8528421}, label: 'ft2/kBtu-hr'},
    ...
    'ft3/min/ton_r': {'convert':(value) => {return value * 3.280839895013123 * 60 * 3516.8528421}, label: 'ft3/min-ton'},
    'l/s/kW': {'convert':(value) => {return value / 1000}, label: 'l/s-kW'},
